...
const ContactSection = () => {
  ...
  return (
    <section>
      <section id="contact" className="text-gray-600 body-font relative bg-BgColor text-TextColor">
          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a href="mailto:icecreames@gmail.com" className="text-indigo-500 leading-relaxed">
                  icecreames@gmail.com
                </a>
          ...
          <div className="relative w-auto max-w-sm mx-auto my-6">
            <div className="bg-white shadow-lg rounded-lg border-2 border-indigo-500">
              <div className="py-4 px-6 text-center">
                ...
                <button
                  className="mt-4 bg-indigo-500 text-white active:bg-indigo-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
